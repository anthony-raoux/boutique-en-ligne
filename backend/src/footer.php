        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="../../images/retro-pac-man.png" class="h-8 me-3" alt="FlowBite Logo" />
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/anthony-raoux/boutique-en-ligne" class="hover:underline ">Github</a>
                      </li>
                      <li>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('create-button').addEventListener('click', () => {
                ...
                modalTitle.textContent = 'Créer un Article';
            ...
            saveButton.addEventListener('click', () => {
                ...
                if (currentArticleIndex !== null) {
                    articles[currentArticleIndex] = { title, content };
                } else {
            ...
            function renderArticles() {
                ...
                articles.forEach((article, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="border px-4 py-2">
                            <button class="bg-green-500 text-white px-4 py-2 rounded mr-2 edit-button" data-index="${index}">Modifier</button>
                            <button class="bg-red-500 text-white px-4 py-2 rounded delete-button" data-index="${index}">Supprimer</button>
                        </td>
                    `;
                ...
                document.querySelectorAll('.edit-button').forEach(button => {
                    button.addEventListener('click', (event) => {
                        currentArticleIndex = event.target.getAttribute('data-index');
