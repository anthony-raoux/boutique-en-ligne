...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit_review'])) {
        ...
        $prenom_utilisateur = $_SESSION['user_prenom'] ?? 'Utilisateur anonyme';
            ...
            <div class="md:w-1/2">
                ...
                <?php if (isset($_SESSION['user_id'])) : ?>
                    <div class="wishlist-btn mb-4">
                        <?php if ($inWishlist) : ?>
                            <form action="details.php?product_id=<?= htmlspecialchars($product_id) ?>" method="POST">
                ...
                <?php if (isset($_SESSION['user_id'])) : ?>
                    <form action="details.php?product_id=<?= htmlspecialchars($id_produit) ?>" method="POST" class="mb-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mt-6">
            ...
            ?>
                    <div class="border p-4 mb-4">
                        ...
                        <p class="text-sm">Par : <?php echo htmlspecialchars($row['prenom_utilisateur'] ?? 'Utilisateur anonyme'); ?> le <?php echo htmlspecialchars($row['created_at'] ?? ''); ?></p>
                        <p class="text-sm"><?php echo htmlspecialchars($row['commentaire'] ?? 'Commentaire non disponible'); ?></p>
                    </div>
            <?php
                endforeach;
            else :
