...
<body class="bg-gray-100">
    <div class="container mx-auto my-5">
        ...
        <!-- Liste des catégories existantes -->
            <section class="mx-auto max-w-screen-2xl pt-2 pb-5 px-4 lg:px-12">
                        ...
                        <?php else : ?>
                            <ul class="list-disc pl-5">
                                <?php foreach ($categories as $category) : ?>
                                    <li class="mb-2">
                                        <span class="text-gray-700"><?php echo htmlspecialchars($category['nom']); ?></span>
                                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="inline">
                                            ...
                                            <button type="submit" name="deleteCategory" class="bg-red-500 text-white px-2 py-1 rounded">Supprimer</button>
                                        </form>
                                        <form action="updateCategory.php" method="get" class="inline">
                                            <input type="hidden" name="id_categorie" value="<?php echo htmlspecialchars($category['id_categorie']); ?>">
